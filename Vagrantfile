...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "../hdspfxvagrantdata", "/vagrant_data"
...
################## Hrayr Code goes here ################################################################
  ...
  # Change the theme
  # TODO: commenting this out, couldnt get it working for some reason!!!   config.vm.provision :shell, inline:"sed -i 's/ZSH_THEME='robbyrussell' /ZSH_THEME='3den' /g' ~/.zshrc"
